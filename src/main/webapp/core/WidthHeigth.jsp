...
$(function(){
	...
	/*
	  ※width()나 height() 혹은 css("속성명")으로
	    가로폭 세로폭을 얻을때는 마진 및 패딩 그리고 보더 값이 미 포함됨  값임.
	...
	*/
	...
	$('button').click(function(){
		...
		console.log('패딩/테두리만 포함:가로폭-%s,세로폭-%s',outerWidth,outerHeight);
		console.log('마진/패딩/테두리 모두 포함:가로폭-%s,세로폭-%s',includeMarginOuterWidth,includeMarginOuterHeight);
		/*css("속성명")으로 가로폭/세로폭 얻기:width()및 height()함수와 같으나 값에 단위가	포함되어 있다.*/
		console.log('마진/패딩/테두리 미 포함(css()함수):가로폭-%s,세로폭-%s',div.css('width'),div.css('height'));
	});
